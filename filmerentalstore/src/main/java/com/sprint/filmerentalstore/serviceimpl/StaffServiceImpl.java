...
public class StaffServiceImpl implements StaffService {
	...
	public StaffDto updateStaff(Short staffId, StaffDto dto) {
        ...
        staff.get().setAddressId(addressRepository.findById(dto.getAddressId()).get());
        staff.get().setEmail(dto.getEmail());
        staff.get().setFirstName(dto.getFirstName());
        staff.get().setLastName(dto.getLastName());
		staff.get().setLastUpdate(LocalDateTime.now());
		staff.get().setActive(dto.getActive());
	...
	public StaffDto addStaff(StaffDto staffDto) {
		...
		staff.setStoreId(storeRepository.findById(staffDto.getStoreId()).get());
		staff.setAddressId(addressRepository.findById(staffDto.getAddressId()).get());
